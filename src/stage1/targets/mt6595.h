...
volatile uint32_t *bladdr=(volatile uint32_t *)0x102768;
volatile uint32_t *bladdr2=(volatile uint32_t *)0x106c88;
volatile uint32_t *uart_reg0 = (volatile uint32_t*)0x11002014;
volatile uint32_t *uart_reg1 = (volatile uint32_t*)0x11002000;

int (*cmd_handler)() = (void*)0xbd53;
